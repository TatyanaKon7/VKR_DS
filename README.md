...
Предположение о наличии зависимости оказалось ложным. Но утверждать о том, что прогнозирование на данном датасете невозможно, не стоит. Можно предположить о недостаточном количестве данных, параметров, неудачных подходов при прогнозировании, незнании теории копмозиционных материалов.
...
13. Создание удалённого репозитория и загрузка результатов работы на него.
    1. https://github.com/TatyanaKon7
